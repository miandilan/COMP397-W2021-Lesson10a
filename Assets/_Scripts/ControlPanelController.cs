...
public class ControlPanelController : MonoBehaviour
{
    ...
    {
        //Serialize and save our data to Player Preferences dictionary / db == what we wanna do
        ...
        PlayerPrefs.SetFloat("playerTransformY", sceneData.playerPosition.x);
        PlayerPrefs.SetFloat("playerTransformZ", sceneData.playerPosition.x);
    ...
    {
        //Deserialize and loading our Data from Player Preferences - What we wanna do
